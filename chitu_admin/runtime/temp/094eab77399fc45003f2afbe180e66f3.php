<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\WWW\chitu_admin\public/../application/admin\view\setting\addtype.html";i:1567500783;s:70:"D:\WWW\chitu_admin\public/../application/admin\view\public\header.html";i:1561462978;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form class="form-horizontal m-t" method="post" action="/admin/setting/savetype" id="commentForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="radio i-checks">
                            <label><input type="radio" value="2" name="status"><i></i>否</label>
                        </div>
                        <div class="radio i-checks">
                            <label><input type="radio"  value="1"  checked="" name="status"><i></i> 是（选中）</label>
                        </div>
                    </div>
                </div>
