<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\WWW\chitu_admin\public/../application/admin\view\setting\delivery_price.html";i:1567651057;s:70:"D:\WWW\chitu_admin\public/../application/admin\view\public\header.html";i:1561462978;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                ...
                <div class="ibox-content">
                    ...
                    <table class="footable table table-stripped toggle-arrow-tiny">
                        ...
                        <tr data-type="">
                            ...
                            <td class="text-left"><?php echo $vo['delivery_time']; ?></td>
                            <td class="text-left"><?php echo $vo['delivery_num']; ?></td>
                            <td class="text-left"><?php echo $vo['delivery_low']; ?></td>
                            <td class="text-left"><?php echo $vo['delivery_inner']; ?></td>
                            <td class="text-left"><?php echo $vo['delivery_outer']; ?></td>
                            <td class="text-center">
                                <a href="/admin/setting/saveprice?id=<?php echo $vo['id']; ?>" class="btn btn-warning">
                                    <span class="glyphicon glyphicon-pencil"></span>
                                    <span>修改</span>
                                </a>
                                <a data-url="/admin/setting/delprice?id=<?php echo $vo['id']; ?>" class="btn btn-danger confir">
