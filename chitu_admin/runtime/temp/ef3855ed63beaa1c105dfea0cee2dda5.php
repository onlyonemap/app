<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\WWW\chitu_admin\public/../application/admin\view\setting\delivery.html";i:1567502056;s:70:"D:\WWW\chitu_admin\public/../application/admin\view\public\header.html";i:1561462978;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <a class="dropdown-toggle"  href="/admin/setting/addtype" style="color: #000;">
                ...
                <div class="ibox-content">
                    ...
                    <table class="footable table table-stripped toggle-arrow-tiny">
                        ...
                        <tr data-type="">
                            <td class="text-left"><?php echo $vo['cid']; ?></td>
                            ...
                            <td class="text-left">
                                ...
                                关闭
                                <?php endif; ?>
                            </td><td class="text-left"><?php echo date("Y-m-d h:i:s",$vo['addtime']); ?></td>
                            <td class="text-center">
                                <a href="/admin/setting/updatedelivery?id=<?php echo $vo['cid']; ?>" class="btn btn-warning">
                                    <span class="glyphicon glyphicon-pencil"></span>
                                    <span>修改</span>
                                </a>
                                <a data-url="/admin/setting/deldelivery?id=<?php echo $vo['cid']; ?>&del=2" class="btn btn-danger confir">
